...
const EditForm = (props)=> {
    ...
    useEffect(() => {
        ...
        .then(res=>{
            ...
            setArticle(res.data); //lives on 'res.data' !
        }).catch(err=>{
            console.error(err);
        })
...
//Task List:
// 1. On mount, make a http request to retrieve the article with the id `editId.` X
// 2. Save result of request to local state. X
